...
export const metadata: Metadata = {
  title: 'Gas Turbine Discs & Rotors for Sale',
  description: 'Source new, refurbished & serviceable gas turbine discs & rotor assemblies for GE Frame 6B, 7FA, 9E, LM2500, Siemens & Solar. ISO 9001 & AS9120 certified.',
  keywords: [
    'gas turbine discs', 'turbine rotor discs', 'compressor discs', 'turbine wheel discs',
    'GE Frame 6B disc', 'GE Frame 7FA disc', 'GE Frame 9E disc',
    'LM2500 turbine discs', 'LM6000 turbine discs', 'Siemens SGT discs', 'Solar Turbines discs',
    'turbine rotor assemblies', 'compressor rotor spools', 'rotor balance hardware',
    'new turbine discs', 'refurbished turbine discs', 'serviceable turbine discs',
    'hot gas path rotating hardware', 'disc spacers and hubs',
    'frame 6b turbine disc', 'frame 7fa compressor rotor disc',
    'LM2500 compressor spool', 'turbine rotor assembly for sale',
    'refurbished gas turbine disc NDT', 'stage 1 turbine disc for GE MS6001',
    'rotor disc balance machine cylindrical',
  ],
  alternates: {
    canonical: `${SITE_URL}/parts/turbine-discs`,
    languages: buildHreflang('/parts/turbine-discs'),
  },
  openGraph: {
    title: 'Gas Turbine Discs & Rotors — New & Refurbished for Sale',
    description: 'Source new, refurbished & serviceable gas turbine discs & rotor assemblies for GE Frame 6B, 7FA, 9E, LM2500, Siemens & Solar. ISO 9001 & AS9120 certified.',
    url: `${SITE_URL}/parts/turbine-discs`,
    siteName: SITE_NAME,
    type: 'website',
    locale: 'en_US',
  ...
  twitter: {
    ...
    title: 'Gas Turbine Discs & Rotors — New & Refurbished',
    description: 'New, refurbished & serviceable gas turbine discs & rotors for GE, Siemens, LM & Solar. ISO 9001 & AS9120. 24-hour quotes.',
    images: [OG_IMAGE],
  },
...
const CONDITIONS = [
  {
    icon: Package,
    title: 'New',
    description: 'OEM-new turbine and compressor discs in original factory packaging with full material certification, dimensional inspection reports, and complete documentation from the original equipment manufacturer.',
  },
  {
    icon: RefreshCw,
    title: 'Refurbished',
    description: 'Professionally refurbished discs that have undergone cleaning, NDT inspection, dimensional verification, and balance restoration by certified repair facilities. Backed by our service warranty.',
  },
  {
    icon: Wrench,
    title: 'Serviceable',
    description: 'Used discs and rotor assemblies with verified remaining service life. Each unit is visually and dimensionally inspected, tagged with condition code, and sold with full disclosure of service history and remaining cycles where available.',
  },
];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Turbine Discs & Rotors', url: `${prefix || ''}/parts/turbine-discs` },
      ]} />
      <SchemaInjector pageKey="turbine-discs" />
      ...
      <main id="main-content" className="flex-1">
        <section className="bg-navy text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">
              Gas Turbine Discs &amp; Rotors
            </h1>
            <p className="text-silver/80 text-xl max-w-3xl mx-auto leading-relaxed">
              Source new, refurbished, and serviceable gas turbine discs and rotor
              assemblies for GE, Siemens, Rolls-Royce, and Solar Turbines. 5M+ NSN/CAGE parts
              in catalog. ISO 9001 &amp; AS9120 certified. 24-hour quote response.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-black text-text mb-6">What Are Gas Turbine Discs &amp; Rotors?</h2>
            <div className="space-y-4 text-text-muted leading-relaxed">
              <p>
                Gas turbine discs are the forged rotor wheels that carry the turbine buckets
                and compressor blades, stacked and bolted together to form the compressor
                rotor spool and turbine rotor assembly. Manufactured from high-strength
                nickel and chromium steels, the discs transmit the enormous centrifugal,
                thermal, and torque loads from the blading to the rotor shaft and generator.
                Each stage — 1, 2, and 3 — is a precision-machined disc with balance land,
                bolt holes, and dovetail slots cut to OEM specification.
              </p>
              <p>
                Discs and rotors are classified as critical rotating hardware and require
                rigorous NDT inspection, life-cycle tracking, and full material certification
                before re-use. Sourcing the correct OEM-equivalent disc — matched by drawing
                number, build level, and service history — is essential for rotor integrity,
                balance, and safe outage planning. We supply new, refurbished, and
                serviceable discs and rotor assemblies with complete documentation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-bg py-16 px-4 border-y border-silver">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-black text-text">Discs &amp; Rotors by Frame and Stage</h2>
              <p className="text-text-muted mt-2 max-w-2xl mx-auto">
                We stock new, refurbished, and serviceable turbine and compressor discs,
                wheel spacers, and rotor assemblies for all major turbine frames — available
                in stage 1, 2, and 3 configurations.
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-text-muted mt-2">
                Every disc and rotor assembly is inspected, documented, and classified by condition.
              </p>
            </div>
        ...
        <section className="bg-bg py-16 px-4 border-y border-silver">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-black text-text">Why Choose Us for Turbine Discs &amp; Rotors</h2>
              <p className="text-text-muted mt-2">
                We combine deep inventory with rigorous quality processes to deliver the right rotating hardware, on time, every time.
              </p>
            </div>
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-black text-text mb-4">Need Discs or Rotors Fast?</h2>
