...
export const metadata: Metadata = {
  title: 'GE MS6001 Parts — Frame 6 Turbine Spares',
  description: 'Source GE MS6001 gas turbine spare parts: buckets, nozzles, transition pieces, combustion liners & fuel nozzles for 6B. ISO 9001 & AS9120. 24-hour quotes.',
  keywords: [
    'GE MS6001 parts', 'MS6001 parts', 'MS6001B spare parts',
    'GE Frame 6 parts', 'GE Frame 6B parts', '6B buckets',
    '6B nozzles', '6B transition pieces', '6B combustion liners',
    'DLN 1 fuel nozzles', 'MS6001 hot gas path', 'MS6001 turbine components',
    'MS6001 shrouds and seals',
    'frame 6b 1st stage bucket', 'frame 6b 1st stage nozzle',
    'frame 6b 2nd stage bucket', 'frame 6b 3rd stage bucket',
    'frame 6b transition piece part number', 'frame 6b hot gas path parts list',
    'ms6001b combustion liner price', 'frame 6b DLN 1 fuel nozzle',
    'ms6001 spares for 24,000 hour inspection',
  ],
  alternates: {
    canonical: `${SITE_URL}/ms6001-parts`,
    languages: buildHreflang('/ms6001-parts'),
  },
  openGraph: {
    title: 'GE MS6001 Parts — Frame 6 Turbine Spares & Components',
    description: 'Source GE MS6001 gas turbine spare parts: buckets, nozzles, transition pieces, combustion liners & fuel nozzles for 6B. ISO 9001 & AS9120. 24-hour quotes.',
    url: `${SITE_URL}/ms6001-parts`,
    siteName: SITE_NAME,
    type: 'website',
    locale: 'en_US',
  ...
  twitter: {
    ...
    title: 'GE MS6001 Parts — Frame 6 Turbine Spares',
    description: 'Source GE MS6001 gas turbine spare parts. ISO 9001 & AS9120. 24-hour quotes.',
    images: [OG_IMAGE],
  },
...
const PARTS_TABLE = [
  {
    ...
    items: [
      { part: 'Stage 1 Bucket', description: 'Directionally solidified superalloy, TBC-coated, fir tree root attachment. Available with and without cooling hole configurations for MS6001 applications.' },
...
const WHY_US = [
  {
    icon: Package,
    title: 'Deep MS6001 Inventory',
    description: 'Over 3,000 unique MS6001 line items in stock across buckets, nozzles, combustion hardware, and seals. Same-day dispatch for in-stock orders.',
  },
  {
    icon: Shield,
    title: 'Certified & Traceable',
    description: 'ISO 9001:2015 and AS9120 Rev B certified. Every MS6001 part ships with full chain-of-custody documentation, OEM cross-reference, and material certs.',
  },
  {
    icon: Zap,
    title: '24-Hour Quotes',
    description: 'Submit your RFQ and receive a binding quote within 24 hours. AOG emergency requests routed directly to our MS6001 product specialists.',
  },
  {
    icon: Cpu,
    title: 'Technical Matching',
    description: 'Our engineers cross-reference OEM part numbers against MS6001 build levels and serial number ranges to ensure form-fit-function match.',
  },
  {
    icon: Award,
    title: 'OEM Equivalent Quality',
    description: 'All MS6001 hardware sourced from OEM-licensed manufacturers and NADCAP-approved coating houses. No grey-market or uncertified alternatives.',
  },
  {
    icon: Wrench,
    title: 'Field Support',
    description: 'Backed by a team of former GE field engineers who understand MS6001 outage schedules, bolting torques, and installation sequencing.',
  },
];
...
export default async function Ms6001PartsPage({ params }: { params: Promise<{ country: string }> }) {
  ...
  const productSchema = {
    ...
    '@type': 'Product',
    name: 'GE MS6001 Gas Turbine Spare Parts',
    description: 'Complete range of GE MS6001 gas turbine hot gas path, combustion, and turbine components including buckets, nozzles, transition pieces, combustion liners, fuel nozzles, shrouds, seals, and retention hardware.',
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: 'GE MS6001 Parts', url: `${prefix || ''}/ms6001-parts` },
      ]} />
        ...
        <section className="bg-navy text-white py-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">
              GE MS6001 Parts — Frame 6 Turbine Spares
            </h1>
            <p className="text-silver/80 text-xl max-w-3xl mx-auto leading-relaxed">
              ...
              GE MS6001 / Frame 6 series heavy-duty gas turbine. ISO 9001 &amp; AS9120 certified.
            </p>
          </div>
        </section>
...
<h2 className="text-3xl font-black text-text mb-8">
                The MS6001 / Frame 6 Series
              </h2>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-3">
                <p className="text-text-muted leading-relaxed mb-6">
                  The GE MS6001 series — commonly known as Frame 6, including the
                  MS6001B (6B) — is a 42 MW, 50/60 Hz heavy-duty gas turbine
                  ...
                  and Africa. With an 11-stage compressor and 3-stage turbine, the MS6001 platform
                  delivers a heat rate of approximately 10,900 Btu/kWh (LHV) and supports
                  DLN 1 or conventional combustion systems. Operators of larger sister frames
                  can source matching{' '}
                ...
                <p className="text-text-muted leading-relaxed">
                  ...
                  Our inventory covers all major MS6001 variants with OEM-licensed and
                  aftermarket-certified components backed by full traceability. For
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-black text-text">
                Why Choose Us for MS6001 Parts
              </h2>
              <p className="text-text-muted mt-2 max-w-2xl mx-auto">
                Certified quality, deep inventory, and engineering expertise
                purpose-built for the GE MS6001 platform.
              </p>
            </div>
