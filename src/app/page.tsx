  ...
  const homepageSchemas: Record<string, unknown>[] = [
    {
      ...
      '@type': 'WebPage',
      name: 'AeroTurbineSpare â€” Precision Aerospace Parts Sourcing',
      description:
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
          HERO â€” Blue/Indigo theme, dynamic from SiteConfig
      â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                {[
                  { title: 'Full Traceability on Every Part', desc: 'Every component comes with complete documentation â€” 8130-3 tags, COCs, and material certifications.' },
                  ...
                  { title: 'Hard-to-Find & Obsolete Parts', desc: 'We specialize in sourcing parts that other distributors cannot locate â€” legacy military and legacy commercial.' },
      ...
      <section className="py-20 bg-gradient-to-r from-[#0A1628] via-[#1E1B4B] to-[#312E81] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
            <Link href="/rfq?urgency=urgent" className="inline-block">
