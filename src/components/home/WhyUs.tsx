      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 text-orange text-sm font-semibold uppercase tracking-wider mb-3">
            <span className="w-6 h-px bg-orange" /> Why AeroTurbineSpare <span className="w-6 h-px bg-orange" />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {FEATURES.map((f) => {
            ...
            return (
              <div
                key={f.title}
                className="group bg-bg border border-silver rounded-2xl p-6 hover:bg-white hover:border-orange/20 hover:shadow-md transition-all duration-300"
              >
                <div className="w-11 h-11 rounded-xl bg-orange/10 flex items-center justify-center mb-4 group-hover:bg-orange group-hover:text-white transition-all duration-300">
